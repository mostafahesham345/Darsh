/* =============================================================================
   ...
   Types we emit, and why:
     ...
     Organization  The business entity. Not ProfessionalService /
                   LocalBusiness: those are LocalBusiness subtypes and are only
                   honest with a real postal address or a declared service
                   area, and Darsh has neither in lib/defaults.js, in the CMS
                   schema, or in any env key. See buildOrganization().
